...
import evalIMG from "../assets/ai_ans.png";
            ...
            <div className='flex-1 px-6 py-20'>
                ...
                <div className='flex justify-center mb-8'>
                    <div className='bg-gray-100 text-gray-600 text-sm px-4 py-2 rounded-full flex items-center gap-2'>
                        <HiSparkles size={18} className="text-green-600" />
                ...
                <div className='text-center mb-24 md:mb-32'>
                    ...
                    >
                        <span className='bg-green-100 text-green-600 px-8 py-3 rounded-full text-3xl md:text-5xl font-semibold'>
                            AI Intelligence
                        </span>
                    </motion.div>
                    ...
                    <motion.p
                        ...
                        className='mt-8 text-gray-500 text-lg max-w-2xl mx-auto leading-relaxed'
                    >
                            ...
                            className='bg-white border border-gray-200 rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all'>
                                <div className='flex flex-col md:flex-row items-center gap-8'>
                                    <div className='w-full md:w-1/2 flex justify-center'>
                                        <img src={item.image} alt={item.title} className='w-full max-h-64 object-contain'/>
                                    </div>
                        ...
                        {[{
                            ...
                            className='bg-white border border-gray-200 rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all'>
                                <div className='flex  items-center justify-between gap-6'>
                                 ...
                                 {/* Image on the right for larger screens, hidden on smaller screens */}
